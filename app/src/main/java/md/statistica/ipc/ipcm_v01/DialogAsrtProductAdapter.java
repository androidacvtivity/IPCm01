...
public class DialogAsrtProductAdapter extends BaseAdapter 
{
	private List<DBClsProducts.ItemClass> listData;
	private LayoutInflater layoutInflater;
	
	//----------------------------------------------------------------------------------------------
	public DialogAsrtProductAdapter(Context context, List<DBClsProducts.ItemClass> listData) 
	{
	...
	public View getView(int position, View convertView, ViewGroup parent) 
	{
		...
		holder.itemName.setText(listData.get(position).getNameFull());
